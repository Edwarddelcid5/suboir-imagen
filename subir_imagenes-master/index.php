...
<body>
  <div class="container">
       ...
       <div class="col-lg-4">
         ...
         <form action="Backend/subir.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <input id="my-input" class="form-control" type="text" name="apellido">
          </div>

          <div class="form-group">
              <label for="my-input">Numero</label>
              <input id="my-input" class="form-control" type="text" name="numero">
          </div>

          <div class="form-group">
              <label for="my-input">Correo</label>
              <input id="my-input" class="form-control" type="text" name="correo">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
              <label for="my-input">ffecha</label>
    ...
    <span aria-hidden="true">&times;</span>
      ...
      <h5 class="card-title"><strong><?php echo $row['apellido']; ?></strong></h5>
    </div>
